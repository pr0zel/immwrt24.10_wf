...
echo "" >> target/linux/x86/64/config-6.6
echo "CONFIG_CPU_FREQ_GOV_CONSERVATIVE=y" >> target/linux/x86/64/config-6.6
echo "" >> target/linux/x86/64/config-6.6
echo "CONFIG_CPU_FREQ_DEFAULT_GOV_SCHEDUTIL=y" >> target/linux/x86/64/config-6.6
