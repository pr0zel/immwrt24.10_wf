...
wget https://raw.githubusercontent.com/pr0zel/packages/refs/heads/master/utils/collectd/patches/101-dns-opcode.patch -O feeds/packages/utils/collectd/patches/101-dns-opcode.patch